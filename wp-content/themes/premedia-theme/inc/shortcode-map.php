...
function map_shortcode_fxn()
{
    ...
    foreach ($rows as $row) {
        ...
        if ($counter == 2 || $counter == 3) {
            ...
            $map_output .= '<svg class="map-pin-svg" version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48" height="48" data-pin="pin-' . $row['slug'] . '" class="map-pin" style="transform: scale(.67) translate(' . $row['horizontal'] . '%, ' . $row['vertical'] . '% );">
            <g>
