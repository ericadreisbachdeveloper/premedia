...
document.addEventListener(
    `DOMContentLoaded`,function () {    
        ...
        if(metroPath && casePath) {
            ...
            metroPath.addEventListener(
                `mouseenter`, function () {
                    metroSvg.parentNode.insertBefore(caseSvg, metroSvg);
                }
            ); 
   
            casePath.addEventListener(
                `mouseenter`, function () {
        ...
        document.querySelectorAll(`.map-pin-path`).forEach(
            function (pin) {
                ...
                {           
                    ...
                    document.getElementById(`clinic-site-city-state`).innerText = clinic.display_city + `, ` + clinic.state_abbrev;
